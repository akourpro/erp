            ...
            <div class="card">
                <div class="card-body">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        if (!empty($search)) {
                            dbSelect("users", "id, name, employee_id, phone", "WHERE name Like '$search%' OR employee_id LIKE ? OR phone LIKE ?", [$search, $search]);
                            if ($countrows >= 1) {
                                ...
                                <?php endforeach;
                                            ...
                                            sweet("error", "فشل", "لم يتم العثور على أي موظف");
                                        }
                                    } else {
