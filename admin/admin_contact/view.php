...
// حفظ البيانات في المتغير message
$message = $rows[0];
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label">الأولوية</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" value="<?php echo $priority ?>" disabled readonly>
                        </div>
                    </div>
