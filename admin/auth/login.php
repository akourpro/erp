    ...
    if (isset($_POST['login'])) {
        ...
        if (empty($email) or empty($password)) {
            ...
            if ($login == "success") {
                ...
                sweet("error", "خطا", "البيانات المدخلة غير صحيحة", "here");
                echo "فشل الدخول";
            }
        }
    }
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        ...
                                        <p class="text-center small">ادخل البريد الالكتروني وكلمة المرور للمتابعة</p>
                                    </div>
                                    ...
                                    <form class="row g-3 needs-validation" novalidate method="post">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                ...
                                                <input type="text" name="email" class="form-control" id="yourUsername" placeholder="ادخل البريد الالكتروني الخاص بك" required>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="password" name="password" class="form-control" id="yourPassword" placeholder="أدخل كلمة السر" required>
                                            <div class="invalid-feedback">يرجى ادخال كلمة السر !</div>
                                        </div>
