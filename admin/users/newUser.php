                    ...
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="password" placeholder="كلمة السر للدخول للنظام" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="submit" class="btn btn-primary" value="إضافة" name="add">
                            </div>
                        </div>
